...
function addToCalendar() {
  ...
  var eventLocation =
    "Church of Jesus Christ of Latter-Day Saints, Teshie 1st Junction";
  ...
  //Notifies user
  alert(
    "To add the wedding to your calendar, please download the .ics file and open it using your calendar application."
  );
